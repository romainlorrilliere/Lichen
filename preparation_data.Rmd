...
knitr::opts_chunk$set(echo = TRUE, message=FALSE, warning=FALSE, cache=FALSE,eval=TRUE)
```
...
if(o==1) my_kable_print(head(d),caption="Entête du premier onglet des données Rhône")
...
my_kable_print(code_po,caption="Table de simplification des polluants",scroll_width = "300px")
